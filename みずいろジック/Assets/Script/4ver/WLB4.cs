...
public class WLB4 : MonoBehaviour {
    public float XScale;
    ...
    void Start()
    {
        ...
        transform.localScale = new Vector3(transform.localScale.x, NowYScale + GameObject.Find("青青4").transform.localScale.y, transform.localScale.z);
    ...
    void Update()
    {
        ...
        if (/*ChengeScale != 0.0f || WB1.ChangeF == 1.0f ||*/ DF != 0)
        {
            ...
            FuturYScale = NowYScale + NowChangeY + WB4.NowChangeY + WG4.NowChangeY;
            WB4.ChangeF = 0.0f;
            a = NowWholeScale;
            DF = 0;
        ...
        if (GF == 2 && WB4.GF == 2 && WG4.GF == 2 && PF == 1)
        {
        ...
        else if (GF == 2 && WB4.GF == 2 && WG4.GF == 2)
        {
            Debug.Log(KMath4.animationf);
            GF = 0;
            WB4.GF = 0;
