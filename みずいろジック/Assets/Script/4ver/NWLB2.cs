...
public class NWLB2 : MonoBehaviour {
    public float XScale;
    ...
    void Update()
    {
        ...
        if (/*ChengeScale != 0.0f || WB2.ChangeF != 0.0f||*/DF != 0)
        {
            ...
            FuturYScale = FuturNowYScale + NWB2.NowChangeY + NWG2.NowChangeY;
            a = FuturYScale;
            NWB2.ChangeF = 0.0f;
            DF = 0;
        ...
        if (GF == 1)
        {
            ...
            if (GF == 2 && NWB2.GF == 2 && NWG2.GF == 2 && PF == 1)
            {
            ...
            else if (GF == 2 && NWB2.GF == 2 && NWG2.GF == 2)
            {
                GF = 0;
                NWB2.GF = 0;
                NWG2.GF = 0;
