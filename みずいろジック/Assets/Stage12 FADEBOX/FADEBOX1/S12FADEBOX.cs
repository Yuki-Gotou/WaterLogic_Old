...
public class S12FADEBOX : MonoBehaviour
{
    Animation fadeanim;
    ...
    void Update()
    {
        ...
        switch (FadeU12)
        {
            ...
            case "Normal":
                ...
                if (Anime0 > fadeanim["12 FADEBOX 12"].length)
            ...
            case "poure":
                ...
                if (Anime0 > fadeanim["12 FADEBOX 12 poure"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU12poure = true;
                    Anime0 = 0.0f;
            ...
            case "Stay":
                ...
                Anime0 += Time.deltaTime;   // 時間を入れる
                //KMath.animationf = 0;
                if (Anime0 > fadeanim["12 FADEBOX 12 Stay"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU12Stay = true;
                    Anime0 = 0.0f;
            ...
            case "finish":
                ...
                if (Anime0 > fadeanim["12 FADEBOX 12 Finish"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU12finish = true;
                    Anime0 = 0.0f;
                    KMath.animationf = 0;
        ...
        switch (FadeU13)
        {
            ...
            case "Normal":
                ...
                if (Anime0 > fadeanim["12 FADEBOX 13"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU13 = true;
                    Anime0 = 0.0f;
                    KMath.animationf = 51;
            ...
            case "poure":
                ...
                if (Anime0 > fadeanim["12 FADEBOX 13 poure"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU13poure = true;
            ...
            case "Stay":
                ...
                if (Anime0 > fadeanim["12 FADEBOX 13 Stay"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU13Stay = true;
                    Anime0 = 0.0f;
            ...
            case "finish":
                ...
                if (Anime0 > fadeanim["12 FADEBOX 13 Finish"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU13finish = true;
                    Anime0 = 0.0f;
                    KMath.animationf = 0;
    ...
    void U12Animation()
    {
        ...
        {
            //1～2傾き
            fadeanim.Play("12 FADEBOX 12 poure");
            FadeU12 = "poure";
        }
        if (KMath.animationf == 1111)
        {
            ...
            //1～2戻る
            fadeanim.Play("12 FADEBOX 12 Stay");
            FadeU12 = "Stay";
        }
        ...
        if (KMath.animationf == 11111)
        {
            ...
            //1～2消える
            fadeanim.Play("12 FADEBOX 12 Finish");
            FadeU12 = "finish";
        }
    }
    ...
    void U13Animation()
    {
        ...
        {
            //1～3傾き
            fadeanim.Play("12 FADEBOX 13 poure");
            FadeU13 = "poure";
        }
        if (KMath.animationf == 5111)
        {
            //1～3戻る
            fadeanim.Play("12 FADEBOX 13 Stay");
            FadeU13 = "Stay";
        }
        ...
        {
            //1～3消える
            fadeanim.Play("12 FADEBOX 13 Finish");
            FadeU13 = "finish";
        }
    }
