...
public class S12FADEBOX2 : MonoBehaviour
{
    Animation fadeanim2;
    ...
    void Update()
    {
        ...
        switch (FadeU21)
        {
            ...
            case "Normal":
                ...
                if (Anime0 > fadeanim2["12 FADEBOX 21"].length)
            ...
            case "poure":
                ...
                if (Anime0 > fadeanim2["12 FADEBOX 21 poure"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU21poure = true;
                    Anime0 = 0.0f;
            ...
            case "Stay":
                ...
                //KMath.animationf = 0;
                if (Anime0 > fadeanim2["12 FADEBOX 21 Stay"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU21Stay = true;
                    Anime0 = 0.0f;
            ...
            case "finish":
                ...
                if (Anime0 > fadeanim2["12 FADEBOX 21 Finish"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU21finish = true;
                    Anime0 = 0.0f;
                    KMath.animationf = 0;
        ...
        switch (FadeU23)
        {
            ...
            case "Normal":
                ...
                if (Anime0 > fadeanim2["12 FADEBOX 23"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU23 = true;
                    Anime0 = 0.0f;
                    KMath.animationf = 31;
            ...
            case "poure":
                ...
                if (Anime0 > fadeanim2["12 FADEBOX 23 poure"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU23poure = true;
            ...
            case "Stay":
                ...
                if (Anime0 > fadeanim2["12 FADEBOX 23 Stay"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU23Stay = true;
                    Anime0 = 0.0f;
            ...
            case "finish":
                ...
                if (Anime0 > fadeanim2["12 FADEBOX 23 Finish"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU23finish = true;
                    Anime0 = 0.0f;
                    KMath.animationf = 0;
    ...
    void U21Animation()
    {
        ...
        {
            //2～1傾き
            fadeanim2.Play("12 FADEBOX 21 poure");
            FadeU21 = "poure";
        }
        ...
        {
            //2～1戻る
            fadeanim2.Play("12 FADEBOX 21 Stay");
            FadeU21 = "Stay";
        }
        ...
        {
            //2～1消える
            fadeanim2.Play("12 FADEBOX 21 Finish");
            FadeU21 = "finish";
        }
    }
    ...
    void U23Animation()
    {
        ...
        {
            //1～3傾き
            fadeanim2.Play("12 FADEBOX 23 poure");
            FadeU23 = "poure";
        }
        if (KMath.animationf == 3111)
        {
            //1～3戻る
            fadeanim2.Play("12 FADEBOX 23 Stay");
            FadeU23 = "Stay";
        }
        ...
        {
            //1～3消える
            fadeanim2.Play("12 FADEBOX 23 Finish");
            FadeU23 = "finish";
        }
    }
