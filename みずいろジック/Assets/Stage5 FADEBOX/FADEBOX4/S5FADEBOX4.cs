...
public class S5FADEBOX4 : MonoBehaviour {
    Animation fadeanim;
    ...
    void Update()
    {
        ...
        switch (FadeU41)
        {
            ...
            case "Normal":
                ...
                if (Anime0 > fadeanim["5 FADEBOX 41"].length)
            ...
            case "poure":
                ...
                if (Anime0 > fadeanim["5 FADEBOX 41 poure"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU41poure = true;
                    Anime0 = 0.0f;
            ...
            case "Stay":
                ...
                //KMath.animationf = 0;
                //                //Water1.count = 0;
                if (Anime0 > fadeanim["5 FADEBOX 41 Stay"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU41Stay = true;
                    Anime0 = 0.0f;
            ...
            case "finish":
                ...
                //KMath4.animationf = 0;
                if (Anime0 > fadeanim["5 FADEBOX 41 Finish"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU41finish = true;
                    Anime0 = 0.0f;
                    KMath4.animationf = 0;
        ...
        switch (FadeU42)
        {
            ...
            case "Normal":
                ...
                if (Anime0 > fadeanim["5 FADEBOX 42"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU42 = true;
                    Anime0 = 0.0f;
            ...
            case "poure":
                ...
                if (Anime0 > fadeanim["5 FADEBOX 42 poure"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU42poure = true;
            ...
            case "Stay":
                ...
                if (Anime0 > fadeanim["5 FADEBOX 42 Stay"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU42Stay = true;
                    Anime0 = 0.0f;
            ...
            case "finish":
                ...
                if (Anime0 > fadeanim["5 FADEBOX 42 Finish"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU42finish = true;
                    Anime0 = 0.0f;
                    KMath4.animationf = 0;
        ...
        switch (FadeU43)
        {
            ...
            case "Normal":
                ...
                if (Anime0 > fadeanim["5 FADEBOX 43"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU43 = true;
                    Anime0 = 0.0f;
            ...
            case "poure":
                ...
                if (Anime0 > fadeanim["5 FADEBOX 43 poure"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU43poure = true;
            ...
            case "Stay":
                ...
                if (Anime0 > fadeanim["5 FADEBOX 43 Stay"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU42Stay = true;
                    Anime0 = 0.0f;
            ...
            case "finish":
                ...
                if (Anime0 > fadeanim["5 FADEBOX 43 Finish"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU42finish = true;
                    Anime0 = 0.0f;
                    KMath4.animationf = 0;
    ...
    void U41Animation()
    {
        ...
        {
            //1～2傾き
            fadeanim.Play("5 FADEBOX 41 poure");
            FadeU41 = "poure";
        }
        if (KMath4.animationf == 10111)
        {
            //1～2戻る
            fadeanim.Play("5 FADEBOX 41 Stay");
            FadeU41 = "Stay";
        }
        ...
        {
            //1～2消える
            fadeanim.Play("5 FADEBOX 41 Finish");
            FadeU41 = "finish";
        }
    }
    ...
    void U42Animation()
    {
        ...
        {
            //1～3傾き
            fadeanim.Play("5 FADEBOX 42 poure");
            FadeU42 = "poure";
        }
        if (KMath4.animationf == 12111)
        {
            //1～3戻る
            fadeanim.Play("5 FADEBOX 42 Stay");
            FadeU42 = "Stay";
        }
        ...
        {
            //1～3消える
            fadeanim.Play("5 FADEBOX 42 Finish");
            FadeU42 = "finish";
        }
    }
    ...
    void U43Animation()
    {
        ...
        {
            //1～4傾き
            fadeanim.Play("5 FADEBOX 43 poure");
            FadeU43 = "poure";
        }
        if (KMath4.animationf == 13111)
        {
            //1～4戻る
            fadeanim.Play("5 FADEBOX 43 Stay");
            FadeU43 = "Stay";
        }
        ...
        {
            //1～4消える
            fadeanim.Play("5 FADEBOX 43 Finish");
            FadeU43 = "finish";
        }
    }
