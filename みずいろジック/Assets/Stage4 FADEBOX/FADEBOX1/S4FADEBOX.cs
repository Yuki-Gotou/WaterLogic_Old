...
public class S4FADEBOX : MonoBehaviour
{
    Animation fadeanim;
...
//                //wave.SetAlpha(0.0f);        // 波のアルファ値の設定
                ...
                if (Anime0 > fadeanim["4 FADEBOX 12"].length)
            ...
            case "poure":
                ...
                if (Anime0 > fadeanim["4 FADEBOX 12 poure"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU12poure = true;
                    Anime0 = 0.0f;
            ...
            case "Stay":
                ...
                //KMath.animationf = 0;
//                //Water1.count = 0;
                if (Anime0 > fadeanim["4 FADEBOX 12 Stay"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU12Stay = true;
                    Anime0 = 0.0f;
            ...
            case "finish":
                ...
                //KMath4.animationf = 0;
                if (Anime0 > fadeanim["4 FADEBOX 12 Finish"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU12finish = true;
                    Anime0 = 0.0f;
                    KMath4.animationf = 0;
...
//                //wave1.SetAlpha(0.0f);        // 波のアルファ値の設定
                ...
                if (Anime0 > fadeanim["4 FADEBOX 13"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU13 = true;
                    Anime0 = 0.0f;
            ...
            case "poure":
                ...
                if (Anime0 > fadeanim["4 FADEBOX 13 poure"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU13poure = true;
            ...
            case "Stay":
                ...
                if (Anime0 > fadeanim["4 FADEBOX 13 Stay"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU13Stay = true;
                    Anime0 = 0.0f;
...
//                //Water1.count = 0;
            ...
            case "finish":
                ...
                if (Anime0 > fadeanim["4 FADEBOX 13 Finish"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU13finish = true;
                    Anime0 = 0.0f;
                    KMath4.animationf = 0;
...
//                        //wave.SetAlpha(0.0f);        // 波のアルファ値の設定
                        ...
                        if (Anime0 > fadeanim["4 FADEBOX 14"].length)
                        {// .length はアニメーションの最大の長さと思われる
                            bFadeU14 = true;
                            Anime0 = 0.0f;
                    ...
                    case "poure":
                        ...
                        if (Anime0 > fadeanim["4 FADEBOX 14 poure"].length)
                        {// .length はアニメーションの最大の長さと思われる
                            bFadeU14poure = true;
                    ...
                    case "Stay":
                        ...
                        if (Anime0 > fadeanim["4 FADEBOX 14 Stay"].length)
                        {// .length はアニメーションの最大の長さと思われる
                            bFadeU13Stay = true;
                            Anime0 = 0.0f;
...
//                        //Water1.count = 0;
                    ...
                    case "finish":
                        ...
                        if (Anime0 > fadeanim["4 FADEBOX 14 Finish"].length)
                        {// .length はアニメーションの最大の長さと思われる
                            bFadeU13finish = true;
                            Anime0 = 0.0f;
                            KMath4.animationf = 0;
    ...
    void U12Animation()
    {
        ...
        {
            //1～2傾き
            fadeanim.Play("4 FADEBOX 12 poure");
            FadeU12 = "poure";
        }
        if (KMath4.animationf == 1111)
        {
            //1～2戻る
            fadeanim.Play("4 FADEBOX 12 Stay");
            FadeU12 = "Stay";
        }
        ...
        {
            //1～2消える
            fadeanim.Play("4 FADEBOX 12 Finish");
            FadeU12 = "finish";
        }
    }
    ...
    void U13Animation()
    {
        ...
        {
            //1～3傾き
            fadeanim.Play("4 FADEBOX 13 poure");
            FadeU13 = "poure";
        }
        if (KMath4.animationf == 5111)
        {
            //1～3戻る
            fadeanim.Play("4 FADEBOX 13 Stay");
            FadeU13 = "Stay";
        }
        ...
        {
            //1～3消える
            fadeanim.Play("4 FADEBOX 13 Finish");
            FadeU13 = "finish";
        }
    }
    ...
    void U14Animation()
    {
        ...
        {
            //1～4傾き
            fadeanim.Play("4 FADEBOX 14 poure");
            FadeU14 = "poure";
        }
        if (KMath4.animationf == 7111)
        {
            //1～4戻る
            fadeanim.Play("4 FADEBOX 14 Stay");
            FadeU14 = "Stay";
        }
        ...
        {
            //1～4消える
            fadeanim.Play("4 FADEBOX 14 Finish");
            FadeU14 = "finish";
        }
    }
