...
public class FADEBOX3 : MonoBehaviour
{
    Animation fadeanim3;
    ...
    void Update()
    {
        ...
        switch (FadeU31)
        {
            ...
            case "Normal":
                ...
                if (Anime0 > fadeanim3["FADEBOX 31"].length)
            ...
            case "poure":
                ...
                if (Anime0 > fadeanim3["FADEBOX 31 poure"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU31poure = true;
            ...
            case "Stay":
                ...
                //KMath.animationf = 0;
                if (Anime0 > fadeanim3["FADEBOX 31 Stay"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU31Stay = true;
                    Anime0 = 0.0f;
            ...
            case "finish":
                ...
                if (Anime0 > fadeanim3["FADEBOX 31 Finish"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU31finish = true;
                    Anime0 = 0.0f;
                    KMath.animationf = 0;
        ...
        switch (FadeU32)
        {
            ...
            case "Normal":
                ...
                if (Anime0 > fadeanim3["FADEBOX 32"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU32 = true;
                    Anime0 = 0.0f;
                    KMath.animationf = 41;
            ...
            case "poure":
                ...
                if (Anime0 > fadeanim3["FADEBOX 32 poure"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU32poure = true;
            ...
            case "Stay":
                ...
                if (Anime0 > fadeanim3["FADEBOX 32 Stay"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU32Stay = true;
                    Anime0 = 0.0f;
            ...
            case "finish":
                ...
                if (Anime0 > fadeanim3["FADEBOX 32 Finish"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU32finish = true;
                    Anime0 = 0.0f;
                    KMath.animationf = 0;
    ...
    void U31Animation()
    {
        ...
        {
            //1～2傾き
            fadeanim3.Play("FADEBOX 31 poure");
            FadeU31 = "poure";
        }
        if (KMath.animationf == 6111)
        {
            //1～2戻る
            fadeanim3.Play("FADEBOX 31 Stay");
            FadeU31 = "Stay";
        }
        ...
        {
            //1～2消える
            fadeanim3.Play("FADEBOX 31 Finish");
            FadeU31 = "finish";
        }
    }
    ...
    void U32Animation()
    {
        ...
        {
            //1～3傾き
            fadeanim3.Play("FADEBOX 32 poure");
            FadeU32 = "poure";
        }
        if (KMath.animationf == 4111)
        {
            //1～3戻る
            fadeanim3.Play("FADEBOX 32 Stay");
            FadeU32 = "Stay";
        }
        ...
        {
            //1～3消える
            fadeanim3.Play("FADEBOX 32 Finish");
            FadeU32 = "finish";
        }
    }
