...
public class S11FADEBOX2 : MonoBehaviour {
    Animation fadeanim;
    ...
    void Update()
    {
        ...
        switch (FadeU21)
        {
            ...
            case "Normal":
                ...
                if (Anime0 > fadeanim["11 FADEBOX 21"].length)
            ...
            case "poure":
                ...
                if (Anime0 > fadeanim["11 FADEBOX 21 poure"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU21poure = true;
                    Anime0 = 0.0f;
            ...
            case "Stay":
                ...
                //KMath.animationf = 0;
                //                //Water1.count = 0;
                if (Anime0 > fadeanim["11 FADEBOX 21 Stay"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU21Stay = true;
                    Anime0 = 0.0f;
            ...
            case "finish":
                ...
                //KMath4.animationf = 0;
                if (Anime0 > fadeanim["11 FADEBOX 21 Finish"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU21finish = true;
                    Anime0 = 0.0f;
                    KMath4.animationf = 0;
        ...
        switch (FadeU23)
        {
            ...
            case "Normal":
                ...
                if (Anime0 > fadeanim["11 FADEBOX 23"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU23 = true;
                    Anime0 = 0.0f;
            ...
            case "poure":
                ...
                if (Anime0 > fadeanim["11 FADEBOX 23 poure"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU23poure = true;
            ...
            case "Stay":
                ...
                if (Anime0 > fadeanim["11 FADEBOX 23 Stay"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU23Stay = true;
                    Anime0 = 0.0f;
            ...
            case "finish":
                ...
                if (Anime0 > fadeanim["11 FADEBOX 23 Finish"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU23finish = true;
                    Anime0 = 0.0f;
                    KMath4.animationf = 0;
        ...
        switch (FadeU24)
        {
            ...
            case "Normal":
                ...
                if (Anime0 > fadeanim["11 FADEBOX 24"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU24 = true;
                    Anime0 = 0.0f;
            ...
            case "poure":
                ...
                if (Anime0 > fadeanim["11 FADEBOX 24 poure"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU24poure = true;
            ...
            case "Stay":
                ...
                if (Anime0 > fadeanim["11 FADEBOX 24 Stay"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU23Stay = true;
                    Anime0 = 0.0f;
            ...
            case "finish":
                ...
                if (Anime0 > fadeanim["11 FADEBOX 24 Finish"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU23finish = true;
                    Anime0 = 0.0f;
                    KMath4.animationf = 0;
    ...
    void U21Animation()
    {
        ...
        {
            //1～2傾き
            fadeanim.Play("11 FADEBOX 21 poure");
            FadeU21 = "poure";
        }
        if (KMath4.animationf == 2111)
        {
            ...
            fadeanim.Play("11 FADEBOX 21 Stay");
            FadeU21 = "Stay";
        }
        ...
        {
            //1～2消える
            fadeanim.Play("11 FADEBOX 21 Finish");
            FadeU21 = "finish";
        }
    }
    ...
    void U23Animation()
    {
        ...
        {
            //1～3傾き
            fadeanim.Play("11 FADEBOX 23 poure");
            FadeU23 = "poure";
        }
        if (KMath4.animationf == 3111)
        {
            //1～3戻る
            fadeanim.Play("11 FADEBOX 23 Stay");
            FadeU23 = "Stay";
        }
        ...
        {
            //1～3消える
            fadeanim.Play("11 FADEBOX 23 Finish");
            FadeU23 = "finish";
        }
    }
    ...
    void U24Animation()
    {
        ...
        {
            //1～4傾き
            fadeanim.Play("11 FADEBOX 24 poure");
            FadeU24 = "poure";
        }
        if (KMath4.animationf == 8111)
        {
            //1～4戻る
            fadeanim.Play("11 FADEBOX 24 Stay");
            FadeU24 = "Stay";
        }
        ...
        {
            //1～4消える
            fadeanim.Play("11 FADEBOX 24 Finish");
            FadeU24 = "finish";
        }
    }
