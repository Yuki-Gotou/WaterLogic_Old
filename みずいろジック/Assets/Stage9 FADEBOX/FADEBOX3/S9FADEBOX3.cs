...
public class S9FADEBOX3 : MonoBehaviour {
    ...
    void Update()
    {
        ...
        switch (FadeU31)
        {
            ...
            case "Normal":
                ...
                if (Anime0 > fadeanim["9 FADEBOX 31"].length)
            ...
            case "poure":
                ...
                if (Anime0 > fadeanim["9 FADEBOX 31 poure"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU31poure = true;
                    Anime0 = 0.0f;
            ...
            case "Stay":
                ...
                //KMath.animationf = 0;
                //                //Water1.count = 0;
                if (Anime0 > fadeanim["9 FADEBOX 31 Stay"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU31Stay = true;
                    Anime0 = 0.0f;
            ...
            case "finish":
                ...
                //KMath4.animationf = 0;
                if (Anime0 > fadeanim["9 FADEBOX 31 Finish"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU31finish = true;
                    Anime0 = 0.0f;
                    KMath4.animationf = 0;
        ...
        switch (FadeU32)
        {
            ...
            case "Normal":
                ...
                if (Anime0 > fadeanim["9 FADEBOX 32"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU32 = true;
                    Anime0 = 0.0f;
            ...
            case "poure":
                ...
                if (Anime0 > fadeanim["9 FADEBOX 32 poure"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU32poure = true;
            ...
            case "Stay":
                ...
                if (Anime0 > fadeanim["9 FADEBOX 32 Stay"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU32Stay = true;
                    Anime0 = 0.0f;
            ...
            case "finish":
                ...
                if (Anime0 > fadeanim["9 FADEBOX 32 Finish"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU32finish = true;
                    Anime0 = 0.0f;
                    KMath4.animationf = 0;
        ...
        switch (FadeU34)
        {
            ...
            case "Normal":
                ...
                KMath4.animationf = 9;
                Debug.Log(KMath4.animationf);
                if (Anime0 > fadeanim["9 FADEBOX 34"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU34 = true;
                    Anime0 = 0.0f;
            ...
            case "poure":
                ...
                if (Anime0 > fadeanim["9 FADEBOX 34 poure"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU34poure = true;
            ...
            case "Stay":
                ...
                if (Anime0 > fadeanim["9 FADEBOX 34 Stay"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU32Stay = true;
                    Anime0 = 0.0f;
            ...
            case "finish":
                ...
                if (Anime0 > fadeanim["9 FADEBOX 34 Finish"].length)
                {// .length はアニメーションの最大の長さと思われる
                    bFadeU32finish = true;
                    Anime0 = 0.0f;
                    KMath4.animationf = 0;
    ...
    void U31Animation()
    {
        ...
        {
            //1～2傾き
            fadeanim.Play("9 FADEBOX 31 poure");
            FadeU31 = "poure";
        }
        if (KMath4.animationf == 6111)
        {
            //1～2戻る
            fadeanim.Play("9 FADEBOX 31 Stay");
            FadeU31 = "Stay";
        }
        ...
        {
            //1～2消える
            fadeanim.Play("9 FADEBOX 31 Finish");
            FadeU31 = "finish";
        }
    }
    ...
    void U32Animation()
    {
        ...
        {
            //1～3傾き
            fadeanim.Play("9 FADEBOX 32 poure");
            FadeU32 = "poure";
        }
        if (KMath4.animationf == 4111)
        {
            //1～3戻る
            fadeanim.Play("9 FADEBOX 32 Stay");
            FadeU32 = "Stay";
        }
        ...
        {
            //1～3消える
            fadeanim.Play("9 FADEBOX 32 Finish");
            FadeU32 = "finish";
        }
    }
    ...
    void U34Animation()
    {
        ...
        {
            //1～4傾き
            fadeanim.Play("9 FADEBOX 34 poure");
            FadeU34 = "poure";
        }
        if (KMath4.animationf == 9111)
        {
            //1～4戻る
            fadeanim.Play("9 FADEBOX 34 Stay");
            FadeU34 = "Stay";
        }
        ...
        {
            //1～4消える
            fadeanim.Play("9 FADEBOX 34 Finish");
            FadeU34 = "finish";
        }
    }
